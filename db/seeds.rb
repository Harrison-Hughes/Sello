...
christmas1 = Product.create(
  ...
  description: "Get in the christmas spirit with this stupid headwear! (WARNING: HIGHLY FLAMMABLE. KEEP AWAY FROM PETS AND CHILDREN)",
  created_at: Time.now,
  price: 7,
  stock_count: 50,
...
christmas2 = Product.create(
  ...
  description: "Miniature crochet Santa brooch is made from cotton thread. Cute and sweet Christmas Santa can decorate your jumper, hat or bag and adds festive feeling for everybody. Perfect gift for friend, family or colleague. (WARNING: HIGHLY FLAMMABLE. KEEP AWAY FROM PETS AND CHILDREN)",
  created_at: Time.now,
  price: 20,
  stock_count: 5,
  user_id: seller_user2.id,
