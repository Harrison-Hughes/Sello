...
product1 = Product.create(name: "seed earrings", description: "desc earrings", created_at: Time.now, price: 10, stock_count: 6, user_id: user1.id)
product2 = Product.create(name: "seed necklaces", description: "desc necklaces", created_at: Time.now, price: 8, stock_count: 10, user_id: user1.id)
product3 = Product.create(name: "seed hats", description: "desc hats", created_at: Time.now, price: 20, stock_count: 5, user_id: user1.id)
